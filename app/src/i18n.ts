...
const en = {
  ...
  mergePickFirst: "Click a corner, or a line, in one room.",
  mergePickSecond: "Now the same corner in another room",
  mergePaired: "Matched",
  mergePairs: "Matches",
  ...
  mergeFit: "Fit",
  mergeClear: "Clear all",
  mergeExport: "Export merged",
  mergeCleared: "Every match dropped",
  merged: "Merged",
  mergeFused: "one body",
  mergeSideBySide: "side by side",
...
const tr: Record<keyof typeof en, string> = {
  ...
  mergePickFirst: "Bir odada bir köşeye ya da çizgiye tıkla.",
  mergePickSecond: "Şimdi başka bir odada aynı köşe",
  mergePaired: "Eşleşti",
  mergePairs: "Eşleşmeler",
  mergeNoPairs: "Henüz eşleşme yok. İki eşleşme bir odayı sabitler; "
  ...
  mergeFit: "Sığdır",
  mergeClear: "Hepsini sil",
  mergeExport: "Birleşmiş dışa aktar",
  mergeCleared: "Bütün eşleşmeler silindi",
  merged: "Birleştirildi",
  mergeFused: "tek gövde",
  mergeSideBySide: "yan yana",
